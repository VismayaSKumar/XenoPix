...
import hair from '../src/assets/avatar/girlAssets/hair/optionImg.png'
import outfit from '../src/assets/avatar/girlAssets/outfit/optionImg.png'
import pet from '../src/assets/avatar/boyAssets/pet/optionImg.png'

import skin1 from '../src/assets/avatar/girlAssets/skin/skin1.png'
import skin3 from '../src/assets/avatar/girlAssets/skin/skin3.png'
import skin2 from '../src/assets/avatar/girlAssets/skin/skin2.png'
...
import hair1 from '../src/assets/avatar/girlAssets/hair/hair1.png'
import hair2 from '../src/assets/avatar/girlAssets/hair/hair2.png'
import hair3 from '../src/assets/avatar/girlAssets/hair/hair3.png'
 
import outfit1 from '../src/assets/avatar/girlAssets/outfit/GirlOutfit1.png'
import outfit2 from '../src/assets/avatar/girlAssets/outfit/GirlOutfit2.png'
import outfit3 from '../src/assets/avatar/girlAssets/outfit/GirlOutfit3.png'
...
function CustomizeGirl() {
  ...
  return (
    <div className='max-h-screen lg:min-h-screen w-full bg-[#FEDE6B] lg:rounded-t-[120px] rounded-t-[80px] p-10 lg:p-20 '>
      ...
      <div className='lg:flex lg:flex-row lg:gap-20 mt-7 lg:mt-15'>
        <div id='avatar-preview' className='avatarContainer aspect-square relative bg-white rounded-[40px] lg:rounded-[60px] flex flex-1/3 justify-center items-center'>
          ...
          <img className='body h-full w-full  object-contain absolute top-0 left-0 z-1' src={girlBody} alt="" />
          ...
          <img className='hair w-[83%] lg:w-[83%] object-contain absolute top-0 z-4' src={selectedLayers.hair} alt="" />
